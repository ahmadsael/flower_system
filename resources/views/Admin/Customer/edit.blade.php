                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <form method="post" action="{{ route('admin.customer.update', $customer->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    <img src="{{ asset('storage/' . $customer->img) }}" alt="Customer Image" class="img-thumbnail" style="max-height: 100px;">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('admin.customer.update.password', $customer->id) }}">
                                        @csrf
                                        @method('PUT')
