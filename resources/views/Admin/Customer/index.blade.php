                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="max-height: 300px; overflow-y: auto;">
                            <form method="GET" action="{{ route('admin.customer.index') }}" class="mb-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-1 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('admin.customer.index') }}" class="btn btn-secondary" style="height: 48px;padding-top: 12px">Reset</a>
                                    </div>
                                    <div class="row g-3">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                                <li><a class="dropdown-item" href="{{ route('admin.customer.export', request()->all()) }}">Export to Excel</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                @forelse($customers as $index => $customer)
                                    <tr>
                                        <th scope="row">{{ ($customers->currentPage() - 1) * $customers->perPage() + $index + 1 }}</th>
                                        <td>{{$customer->name}}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form method="post" action="{{route('admin.customer.delete' , $customer->id)}}">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="dropdown-item btn" type="submit" onclick="return confirm('Are you sure you want to delete this customer?')">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <form method="GET" action="{{ route('admin.customer.index') }}" class="d-inline-flex align-items-center">
