                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            >
                                                ...
                                                @foreach($types as $type)
                                                    <option value="{{$type}}" {{ old('type_name') == $type ? 'selected' : '' }}>
                                                        {{ ucfirst($type) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select" name="type_name" id="type_name">
                                            <option value="">All</option>
                                            <option value="admin" {{ request('type_name') === 'admin' ? 'selected' : '' }}>Admin</option>
                                            <option value="ai_admin" {{ request('type_name') === 'ai_admin' ? 'selected' : '' }}>AI Admin</option>
                                        </select>
                                    </div>
