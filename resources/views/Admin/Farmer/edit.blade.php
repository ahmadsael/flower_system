                        ...
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0">Edit Farmer</h5>
                                    <a href="{{ route('admin.farmer.index') }}" class="btn btn-secondary">Back</a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('admin.farmer.update', $farmer->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    <img src="{{ asset('storage/' . $farmer->img) }}" alt="Farmer Image" class="img-thumbnail" style="max-height: 100px;">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input
                                                        ...
                                                        value="{{ old('birthday', $farmer->birthday) }}"
                                                        required
                                                    />
                                                </div>
                                                @error('birthday')
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('admin.farmer.update.password', $farmer->id) }}">
                                        @csrf
                                        @method('PUT')
